...
test('should generate 101 grayscale colors in default LAB colorspace)', function() {
  let colors = new BackgroundColor({colorKeys: ['#ffffff']}).backgroundColorScale;
...
test('should generate 101 blue toned grayscale colors in HSL space)', function() {
  let colors = new BackgroundColor({colorKeys: ['#4a5b7b','#72829c','#a6b2c6'], colorspace: 'HSL'}).backgroundColorScale;
...
test('should generate 101 blue toned grayscale colors in LAB space)', function() {
  let colors = new BackgroundColor({colorKeys: ['#4a5b7b','#72829c','#a6b2c6'], colorspace: 'LAB'}).backgroundColorScale;
...
test('should generate 101 blue colors in HSLuv space)', function() {
  let colors = new BackgroundColor({colorKeys: ['#6FA7FF', '#B5E6FF'], colorspace: 'HSLuv'}).backgroundColorScale;
