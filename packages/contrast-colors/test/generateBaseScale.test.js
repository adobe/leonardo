...
test('should generate 101 blue toned grayscale colors in HSL space)', function() {
  let colors = generateBaseScale({colorKeys: ['#4a5b7b','#72829c','#a6b2c6'], colorspace: 'HSL'});;
...
test('should generate 101 blue toned grayscale colors in LAB space)', function() {
  let colors = generateBaseScale({colorKeys: ['#4a5b7b','#72829c','#a6b2c6'], colorspace: 'LAB'});;
...
test('should generate 101 blue colors in HSLuv space)', function() {
  let colors = generateBaseScale({colorKeys: ['#6FA7FF', '#B5E6FF'], colorspace: 'HSLuv'});;
