...
import { createHtmlElement } from './js/createHtmlElement';
import {colorPicker, createColorPicker} from './js/colorPicker';
...
function setup() {
  ...
  // document.getElementById('colorPicker').addEventListener('click', colorPicker)
  createColorPicker('testWrapper')
}
setup();
