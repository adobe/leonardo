...
document
  .getElementById("themeNameInput")
  .addEventListener("change", throttle(themeUpdateParams, 50));
// Update theme when base color selection is changed
document
  .getElementById("themeBase")
  .addEventListener("input", throttle(themeUpdateParams, 50));
