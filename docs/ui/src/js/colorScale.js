...
function addColorScale(newColor, addToTheme = true) {
  ...
  colorNameInputWrapper.className =
    "spectrum-Textfield spectrum-Textfield--quiet colorNameInput";
  ...
  actions.className =
    "spectrum-ButtonGroup spectrum-Form-item spectrum-Form-item--row labelSpacer";
  ...
  document
    ...
    .addEventListener("input", baseScaleOptions);
