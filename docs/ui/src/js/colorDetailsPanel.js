...
function showColorDetails(e, colorId) {
  ...
  let triggeredColorNameInput = document.getElementById(
    triggeredColorNameInputId,
  );
  ...
  configPanelTopWrapper.className =
    "spectrum-Panel-Item spectrum-Panel-Item--noPadding";
  ...
  backButton.className =
    "spectrum-Button spectrum-Button--sizeM spectrum-Button--cta spectrum-ButtonGroup-item";
  ...
  addButton.className =
    "spectrum-ActionButton spectrum-ActionButton--sizeM spectrum-ActionButton--quiet";
  ...
  clearKeyColorsButton.className =
    "spectrum-ActionButton spectrum-ActionButton--sizeM spectrum-ActionButton--quiet";
  ...
  panelInterpTitle.className =
    "spectrum-Heading spectrum-Heading--sizeXXS spectrum-Panel-Item-Title";
  ...
  interpLabel.className =
    "spectrum-FieldLabel spectrum-Fieldlabel--sizeM spectrum-FieldLabel--left";
  ...
  for (let index in opts) {
    interpSelect.options[interpSelect.options.length] = new Option(
      opts[index],
      index,
    );
  }
  ...
  interpDetails.innerHTML =
    "Color scales intersect each of your key colors by a straight line in color space. Different color spaces will change the appearance of your scale.";

  let downloadGradient = document.createElement("button");
  downloadGradient.className =
    "spectrum-ActionButton spectrum-ActionButton--sizeM spectrum-ActionButton--quiet";
...
<span class="spectrum-ActionButton-label">Download SVG gradient</span>`;
  downloadGradient.addEventListener("click", (e) => {
    downloadSVGgradient(
      colorData.backgroundColorScale,
      colorData.colorspace,
      colorData.name,
    );
  });
  ...
  deleteColor.className =
    "spectrum-Button spectrum-Button--sizeM spectrum-Button--negative";
  ...
  title.className =
    "spectrum-Typography spectrum-Heading spectrum-Heading--sizeXS";
  ...
  tabs.className =
    "spectrum-Tabs spectrum-Tabs--horizontal spectrum-Tabs--quiet";
  ...
  for (let index in chartsSelectOpts) {
    chartsSelect.options[chartsSelect.options.length] = new Option(
      chartsSelectOpts[index],
      index,
    );
  }
  ...
  chartsModeSelect.addEventListener("change", (e) => {
    if (panelOpen) {
      ...
      let lightness =
        e.target.value === "HSV" ? 100 : e.target.value === "HSLuv" ? 60 : 50;
  ...
  document
    .getElementById(thisId.concat("_colorName"))
